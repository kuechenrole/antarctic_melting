...
vvel(TimeInd,:,:,:) = permute(ncread([external_dir,'/ecco2/VVEL.nc/VVEL.1440x720x50.' num2str(monstr(TimeInd)) '.nc'],'VVEL',[Xloc(1) Yloc(1) 1 1],[Xloc(2)-Xloc(1)+1 Yloc(2)-Yloc(1)+1 Inf Inf]),[3 1 2]);

disp([num2str(TimeInd) ' of ' num2str(12*(MaxYear-MinYear+1)) ' month done.'])
end

save(fullfile(interim_dir,['cube92_iaf_vvel_',RunName,'.mat']),'vvel','-v7.3')
