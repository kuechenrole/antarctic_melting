...
load(fullfile(interim_dir,['cube92_iaf_salt_',RunName,'.mat']))
...
isfc.ssh(i,:) = inpaint_nans(interp2(Xm2,Ym2,In3,squeeze(LatInterpSurface(31,:)),squeeze(LonInterpSurface(31,:)),InterpFcn),2);
